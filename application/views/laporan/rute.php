	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<div class="table-responsive" id="trute">
					<table class="table">
						<thead>
							<tr>
								<th>No</th>
...
<script type="text/javascript">
	...
	function getrutefirst(type){
		var url = "<?php echo site_url('report/getrutefirst/'); ?>"+'<?php echo $type;?>';
		$.get(url,function(x){
			$('#trute').html(x);
		});
	...
	function getrute(from,to,type){
		var url = "<?php echo site_url('report/getrute/'); ?>"+from+'/'+to+'/'+'<?php echo $type;?>';
		$.get(url,function(x){
			$('#trute').html(x);
		});
		datatablerute();
	...
	function datatablerute(){
		...
		// ajax : "<?php echo site_url('report/getrutefirst'); ?>"
	});
	}
</script>